...
import 'package:rentcar_app/pages/book_car_page.dart';
...
class DetailPage extends StatelessWidget {
  ...
  final int index;
  const DetailPage({super.key, required this.index, required this.items});
                        ...
                        child: InkWell(
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    BookCarPage(index: index, items: items),
                              ),
                            );
                          },
                          child: FadeInUp(
